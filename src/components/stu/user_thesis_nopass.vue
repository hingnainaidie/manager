    ...
    <div class="main">
      <div>
        <el-row>
          ...
          <el-col :span='14' class='title'>我的未审核论文信息</el-col>
        </el-row>
      </div>
      <div class='com'>
        <el-table border :data='datas' style='width: 100%; padding: auto;'>
          <el-table-column prop='cate_name' label='赛事类别' width="250" :filters="ccate" :filter-method="filterHandler">
          </el-table-column>
          <el-table-column prop='com_num' label='竞赛届数' width="150" :filters="cnum" :filter-method="filterHandler">
          </el-table-column>
          <el-table-column prop='thesis_name' label='论文标题' width="150"></el-table-column>
          <el-table-column label='操作'>
            <template slot-scope='scope'>
              ...
              <el-button size="mini" type="danger" @click='del(scope.row.thesis_id)'>删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
